...
It was programmed object oriented. There is a total of 4 classes:
       ...
       3. "TaskExtractor.py" This class acts as the "brain" of the system by scanning page content for specific score patterns (like "(3)") to determine where tasks begin and end. It then translates these visual               markers into precise mathematical coordinates for the cropping process.
